...
ckp = torch.load('./ckp/jointNet.pth')
cfg = ckp['config']
cfg.CLASSES_NAME = ('__back_ground__', 'barcode')

pprint(cfg)

img = Image.open('/home/artem/PycharmProjects/CenterNetRefs/ZVZ-real-512/Image/QR-photo_26_0019.jpg').convert('RGB')
