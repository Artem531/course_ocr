...
# dataset
Config.num_classes = len(Config.CLASSES_NAME)
Config.batch_size = 16
Config.root =  "/home/artem/PycharmProjects/course_ocr/course_ocr/task1/midv500_compressed"
