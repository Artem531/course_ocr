...
class CenterNet(nn.Module):
    def __init__(self, cfg):
        ...
        #self.head = HeadJointPoints(channel=cfg.head_channel, num_classes=cfg.num_classes)
    ...
    @torch.no_grad()
    def inference(self, img, topK=40, return_hm=False, th=None):
        ...
        bboxes = gather_feature(pred_wh, index, use_transform=True)
        bboxes = bboxes.reshape(b, topK, 8)
        print(bboxes)
